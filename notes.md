...
Application components - src/components/apps/

- [ ] nodepad++ to update and run code (NotepadPlusPlus.tsx)
- [ ] command prompt to access and run code (CommandPrompt.tsx)

## Person 4 - Game Logic & Backend (James)
